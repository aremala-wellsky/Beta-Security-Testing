...
SELECT DISTINCT (sec.user_access_tier || '|' || sec.user_provider_id) AS tier_link, entry_date, exit_date, user_access_tier, user_provider_id, client_id, entry_exit_id, covered_by_roi, sec.provider_id AS provider_id
