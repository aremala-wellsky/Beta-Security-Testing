...
SELECT
b.entry_exit_id, b.question_id, b.virt_field_name, 1 AS entryexit, da3.date_effective,
...
FROM (
    ...
    FROM (
        ...
        WHERE da.active AND (da.date_effective::DATE <= ee.exit_date::DATE OR ee.exit_date IS NULL)
